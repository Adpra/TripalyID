<section class="triplay-game-list">
    <div class="container">
        ...
        <div class="game-list__wrapper row">
            <div class="card-game col-lg-4" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
            ...
            <div class="card-game col-lg-4" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
                <img src="{{ asset('img/ml.jpg') }}" alt="PUBG">
                <a class="button-shop" href="#">BELI</a>
                <div class="game-name">
            ...
            <div class="card-game col-lg-4" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
                <img src="{{ asset('img/aov.jpg') }}" alt="PUBG">
                <a class="button-shop" href="#">BELI</a>
                <div class="game-name">
